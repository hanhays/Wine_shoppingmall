...
public class MemberDTO implements Serializable{
	...
	public MemberDTO(String mem_id, String mem_pw, String mem_name, String mem_gender, String mem_contact,
			String mem_regdate, String mem_birth, String mem_address1, String mem_address2, String mem_address3,
			String mem_email, String mem_type) {
		super();
		this.mem_id = mem_id;
		this.mem_pw = mem_pw;
	...
	public String toString() {
		return "MemberDTO [mem_id=" + mem_id + ", mem_name=" + mem_name + ", mem_birth=" + mem_birth + "]";
	}
