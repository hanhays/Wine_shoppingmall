...
<body>
	...
	<br><h2 style="text-align: center">Q&A</h2><br>
		...
		<form role="form" action="/qnaboard/insert" method="post">
		<table class="table table-striped">
			<thead>
				<tr>
					<th colspan="3" style="text-align: cener;"><h5>Write Form</h5></th>
					<th><h6>ID</h6></th>
			...
			<tbody>
				...
				<tr>
					<td style="text-align: left;" colspan="5">
						<h6><input class="btn btn-danger pull-right" type="submit" value="Write"></h6>
					</td>
				</tr>
			</tbody>
		</table>
